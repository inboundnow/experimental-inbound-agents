            ...
            $settings['inbound-pro-settings'][] = array(
                ...
                'fields' => array(
                    ...
                    array(
                        ...
                        'type' => 'radio',
                        'label' => __('Rotate Agent Lead Assignment', 'inbound-pro'),
                        'default' => '0',
                        'options' => array(
                            '0' => 'Assign to all form agents',
                            '1' => 'Assign on a rotational basis'
                        ),
                    ...
                    array(
                        ...
                        'type' => 'dropdown',
                        'label' => __('Lead Group Form Submission Limit Policy', 'inbound-pro'),
                        'default' => '0',
                        'options' => array(
                            '0' => 'Set limits for all agent groups',
                            '1' => 'Set limits for individual agent groups',
                        ),
